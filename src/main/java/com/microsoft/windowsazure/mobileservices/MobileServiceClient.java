...
public class MobileServiceClient {
    ...
    */
     ...
     */
    public void login(Activity activity, String provider, String uriScheme, int authRequestCode) {
        this.mCustomTabsLoginManager.authenticate(provider, uriScheme, null, activity, authRequestCode);
    }
     ...
     */
    public void login(Activity activity, String provider, String uriScheme, int authRequestCode, HashMap<String, String> parameters) {
        this.mCustomTabsLoginManager.authenticate(provider, uriScheme, parameters, activity, authRequestCode);
    }
     ...
     *                   authentication
     * @param callback   Callback to invoke when the authentication process finishes
     * @deprecated use {@link #login(MobileServiceAuthenticationProvider provider, JsonObject oAuthToken)} instead
     */
     ...
     * @param oAuthToken The oAuth token used for authentication
     * @param callback   Callback to invoke when the authentication process finishes
     * @deprecated use {@link #login(MobileServiceAuthenticationProvider provider, String oAuthToken)} instead
     */
     ...
     * @param scopes   The scopes used as authentication token type for login
     * @param callback Callback to invoke when the authentication process finishes
     * @deprecated use {@link #loginWithGoogleAccount(Activity activity, String scopes)} instead
     */
     ...
     * @param account  The account used for the login operation
     * @param callback Callback to invoke when the authentication process finishes
     * @deprecated use {@link #loginWithGoogleAccount(Activity activity, Account account)} instead
     */
     ...
     * @param scopes   The scopes used as authentication token type for login
     * @param callback Callback to invoke when the authentication process finishes
     * @deprecated use {@link #loginWithGoogleAccount(Activity activity, Account account, String scopes)} instead
     */
     ...
     * @param parameters The query string parameters sent in the request
     * @param callback   The callback to invoke after the API execution
     * @deprecated use {@link #invokeApi(String apiName, JsonElement body, String httpMethod, List parameters)} instead
     */
    ...
    private void initialize(URL appUrl, MobileServiceUser currentUser, GsonBuilder gsonBuilder, Context context,
        ...
        mPush = new MobileServicePush(this, appContext);
